...
* **100. Owner and group**
  * [100-change_owner_and_group](./14-change_owner_and_group): Bash script that changes the
...
* **102. If only**
  * [102-if_only](./16-if_only): Bash script that changes the owner of the file `hello`
