...
Upon the release of ALX-Holberton School's System Engineering & DevOps project 0x19,
approximately 8:00 GMT+1, an outage occurred on an isolated
...
simple ALX-Holberton WordPress site.

## Debugging Process

Bug debugger Badr encountered the issue upon opening the project and being, well, instructed to
address it, roughly 19:20 GTM+1. He promptly proceeded to undergo solving the problem.
...
[0-strace_is_your_friend.pp](https://github.com/Badrdineyk/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
